  ...
  return (
    <div className="h-full p-2 md:p-8 flex flex-col gap-3 md:gap-6">
      <div className="flex items-center justify-between px-1 md:px-0 shrink-0">
        <div>
          <h1 className="text-lg md:text-2xl font-bold text-stone-800 tracking-tight">My Schedule</h1>
          <p className="hidden md:block text-stone-500 text-sm mt-1">Manage your weekly classes</p>
        </div>
        <button
